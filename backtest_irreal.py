...
# (viven aquí — separados de config_local)
# ══════════════════════════════════════════════════════════════════════════════
...
def main() -> None:
    ...
    for candle in clock:
        ...
        if risk_reason:
            ...
            # Registrar como ignorado en la Wallet para el JSON
